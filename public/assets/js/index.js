...
function renderRedHeart(elem){
    const html=`
        <img class="js-red-heart absolute top-[3%] right-[2%] h-5 w-5 md:w-6 md:h-6" src="./assets/resources/red-heart.png" alt="">
    `
    elem.innerHTML=html;
}
...
function renderWhiteHeart(elem){
    const html=`
        <img class="js-white-heart absolute top-[3%] right-[2%] h-5 w-5 md:w-6 md:h-6" src="./assets/resources/whitre-heart.png" alt="">
    `
    elem.innerHTML=html;
}
